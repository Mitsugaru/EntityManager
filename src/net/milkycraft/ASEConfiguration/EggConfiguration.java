 ...
 */
public class EggConfiguration extends org.bukkit.configuration.file.YamlConfiguration {
	...
	public EggConfiguration(Plugin plugin){
		this("config.yml", plugin);
	}
	public EggConfiguration(String file, Plugin plugin){
		this(new File(plugin.getDataFolder(), file), plugin);
	}
	public EggConfiguration(File file){
		this(file, null);
	}

	public EggConfiguration(File file, Plugin plugin){
		this.file = file;
		this.plugin = plugin;
		options = new EggConfigurationOptions(this);
		load();
	}
	...
	@Override
	public EggConfigurationOptions options(){
		return (EggConfigurationOptions) options;
	}
